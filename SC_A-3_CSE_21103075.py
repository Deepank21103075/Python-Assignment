...
a = a.lower()             #Converting the String Into Lowercase
list=a.split() 
dict={} 
if list.__len__() == 1:   #For Single Words
    for i in list[0]:
        if i in dict:
            dict[i]+=1
        else:
...
def input_date():
    ...
    if day > 28 and month == 2 and year%4 != 0:
        ...
        print("Please Re-enter A Valid Date!!")
        input_date()
input_date()                  #Check For Leap Years
if (day == 28 and month == 2 and year%4 != 0):                                                        
    day = 1
    month = 3
...
if month == 13:
    month = 1
    year += 1
print("Next Date Is: ", day,'/',month,'/',year)      #Printing The Next Date
